...
CREATE TABLE IF NOT EXISTS `almacen` (
  ...
  CONSTRAINT `almacen_ibfk_1` FOREIGN KEY (`fk_producto`) REFERENCES `productos` (`id`)
...
CREATE TABLE IF NOT EXISTS `entradas` (
  ...
  CONSTRAINT `entradas_ibfk_1` FOREIGN KEY (`fk_producto`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `pedidolinea` (
  ...
  CONSTRAINT `pedidolinea_ibfk_1` FOREIGN KEY (`fk_cliente`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE IF NOT EXISTS `pedidolocal` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mesa` (`fk_mesa`),
  CONSTRAINT `pedidolocal_ibfk_1` FOREIGN KEY (`fk_mesa`) REFERENCES `mesas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`fk_categoria`) REFERENCES `categoria` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `productospedidolinea` (
  ...
  KEY `fk_producto` (`fk_producto`),
  CONSTRAINT `productospedidolinea_ibfk_1` FOREIGN KEY (`fk_pedidolinea`) REFERENCES `pedidolinea` (`id`),
  CONSTRAINT `productospedidolinea_ibfk_2` FOREIGN KEY (`fk_producto`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `productospedidolocal` (
  ...
  KEY `fk_producto` (`fk_producto`),
  CONSTRAINT `productospedidolocal_ibfk_1` FOREIGN KEY (`fk_pedidolocal`) REFERENCES `pedidolocal` (`id`),
  CONSTRAINT `productospedidolocal_ibfk_2` FOREIGN KEY (`fk_producto`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `salidas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_producto` (`fk_producto`),
  CONSTRAINT `salidas_ibfk_1` FOREIGN KEY (`fk_producto`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_rol` (`fk_rol`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`fk_rol`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ventalinea` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_pedidolinea` (`fk_pedidolinea`),
  CONSTRAINT `ventalinea_ibfk_1` FOREIGN KEY (`fk_pedidolinea`) REFERENCES `pedidolinea` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ventalocal` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_pedidolocal` (`fk_pedidolocal`),
  CONSTRAINT `ventalocal_ibfk_1` FOREIGN KEY (`fk_pedidolocal`) REFERENCES `pedidolocal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
