    ...
    header.addEventListener('click', async () => {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', async (e) => {
                e.preventDefault();
                let deleteConfirmation = confirm(`¿Eliminar producto de la orden ${header.dataset.id}?`)
        ...
        cuantityEditButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                saveCuantityBtn.addEventListener('click', async () => {
                    const headerclicked = document.querySelector(`[data-id="${header.dataset.id}"]`)
                    let confirmCuantityEdit = confirm(`¿Guardar cambios en la orden ${header.dataset.id}`)
